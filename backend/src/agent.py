...
print("\n" + "💼" * 50)
print("🚀 AI SDR AGENT: LEAD CAPTURE SESSION")
print("📚 CONTEXT: Cloud & AI Course Sales")
...
# Default FAQ data for "Digital Learning Store"
DEFAULT_FAQ = [
    {
        "question": "What do you sell?",
        "answer": "We offer premium courses on Cloud Computing, Google Cloud Arcade, and Voice AI Agent development. We also sell exclusive tech merchandise like hoodies and mugs."
    },
    {
    ...
    },
    {
        ...
        "answer": "Yes! We release weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Digital Learning Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with the sales team and email you." (Don't hallucinate prices).
            """,
